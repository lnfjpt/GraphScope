...
if __name__ == '__main__':
    ...
    print("query count: %d, min time: %d, max time %d, mean time %d, P50 %d, P90 %d, P95 %d, P99 %d" % (query_count / worker_num, query_time[0], query_time[-1], mean_time, query_time[-index_50], query_time[-index_90], query_time[-index_95], query_time[-index_99]))
