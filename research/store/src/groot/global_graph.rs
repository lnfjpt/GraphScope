...
use super::super::db::api::{GraphResult, ValueRef, ValueType, EdgeDirection, GraphConfigBuilder, GraphConfig, GraphDef, Records, PropertyId};
use std::sync::Arc;
use super::super::api::{GlobalGraphQuery, SnapshotId, PartitionVertexIds, LabelId, Condition, PropId, VertexId, PartitionId, PartitionLabeledVertexIds};
use super::{LocalStoreVertex, LocalStoreEdge};
use super::super::api::graph_schema::Schema;
use std::collections::{HashMap, HashSet};
use std::vec::IntoIter;
use super::super::api::prelude::Property;
use std::iter::FromIterator;
use itertools::Itertools;
use super::super::api::graph_partition::GraphPartitionManager;
use super::super::config::StoreConfig;
use super::super::db::graph::store::GraphStore;
use super::global_graph_schema::GlobalGraphSchema;
use super::super::db::graph::entity::{RocksVertexImpl, RocksEdgeImpl};
use super::super::db::api::multi_version_graph::MultiVersionGraph;
use super::super::db::api::types::RocksEdge;
use super::super::db::storage::RawBytes;
...
impl GlobalGraph {
    ...
    fn parse_condition(condition: Option<&Condition>) -> Option<&super::super::db::api::condition::Condition> {
        None
    }
