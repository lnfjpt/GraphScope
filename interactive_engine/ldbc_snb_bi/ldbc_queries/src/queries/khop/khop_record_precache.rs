...
// /// the Record Version. And we apply precache for property.
// pub fn khop_record_precache(conf: JobConf) -> ResultStream<u64> {
...
//                 })
//                 // auxilia to precache a."id"
//                 .map(move |mut post_record: Record| {
...
//                     let runtime_post_vertex = to_runtime_vertex(post_vertex, Some(vec!["id".into()]));
//                     post_record.append(runtime_post_vertex, Some(0));
//                     Ok(post_record)
//                 })?
//                 // .in("REPLYOF")
...
//                     let runtime_post_vertex = message_record
//                         .get(Some(0))
//                         .unwrap()
//                         .as_graph_vertex()
//                         .unwrap();
